...
export { createVehicleGlbMesh, createBoxVehicleMesh } from './src/createVehicleMesh.js';   // A-DRIVE: ONE loader for every modelled vehicle — articulated parts arrive as a DATA table   // A-FEEL: createRoadModel = a car that corners on a street grid (curvature-limited steering, R grows with v squared). A-MOTO: createBikeModel = the two-phase dirtbike
