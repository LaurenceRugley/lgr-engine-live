...
export { createBoxArena, swingableHeight, swingableRope, topAtPercentile } from './src/box-arena.js';   // A-LAB: parameterised proving-ground geometry (flat floor + tower grid) that hands back the four-function world bag
